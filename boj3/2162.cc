...
bool segments_intersect(const segment &s1, const segment &s2) {
  ...
  if (((d1 < 0 && d2 > 0) || (d1 > 0 && d2 < 0)) &&
      ((d3 < 0 && d4 > 0) || (d3 > 0 && d4 < 0)))
    return true;
  else if (d1 == 0 && on_segment(s2.p1, s2.p2, s1.p1))
    return true;
  else if (d2 == 0 && on_segment(s2.p1, s2.p2, s1.p2))
    return true;
  else if (d3 == 0 && on_segment(s1.p1, s1.p2, s2.p1))
    return true;
  else if (d4 == 0 && on_segment(s1.p1, s1.p2, s2.p2))
    return true;
